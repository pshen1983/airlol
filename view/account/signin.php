...
<input class="inputbox" name="email" placeholder="<?=View::$content['email_label'] ?>" value="<?=(isset($params['email']) ? $params['email'] : '') ?>"/>
<input class="inputbox" name="password" placeholder="<?=View::$content['passwd_label'] ?>" type="password" <?=(isset($params['email']) ? 'autofocus' : '') ?>/>
<div id="bottom_div">
